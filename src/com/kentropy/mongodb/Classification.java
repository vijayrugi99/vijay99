...
{	
	...
	public int generate20Percent(Date datefrm,Date dateto,String facility,MongoDAO mongodao,MongoDAO mongodao1,MongoDAO mongodao2, String counter)
	{ 		
	   ArrayList<DBObject> jsonArray =mongodao.listOfUniqueBabies(datefrm,dateto,facility,"test_Nov11");
	//   ArrayList<DBObject> jsonArray2 =mongodao2.listOfUniqueBabies(datefrm,dateto,facility);
	 ...
	 // System.out.println("uniquebabyt data::"+jsonArray+"counter="+counter );
	...
	public static Object getNextRecordID(String name,String db,String coll,MongoDAO mongodao) 
	{
		...
		//System.out.println("inside generate reocrd "+name+""+db+""+coll+""+mongodao);
...
{
		int d=0,r=0,g=0,un=0,u=0;		
			ArrayList<DBObject> listOfMothers=mongodao.listOfRepeatingMother(datefrm,dateto,facility,mongodao.collection);
			...
			if(listOfMothers.size()>0)
			{
				for(int j=0;j<listOfMothers.size();j++)
				{
					...
					{ 
						...
						DBObject obj1 =(DBObject) mongodao.babyByUniqueID(uid1,mongodao.collection);//get Object
				    ...
				    {	gid2=null;
						...
						DBObject obj2 = (DBObject)mongodao.babyByUniqueID(uid2,mongodao.collection);
