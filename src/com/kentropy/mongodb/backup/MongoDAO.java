...
public class MongoDAO 
{
	...
	*/
	...
	/*
	 * List of repeating mother_name, father_name, dob using $group operation for both test and homeborn collection
	 * @param startDt - from date
	 * @param endDate - to date
	 */
	...
	/**
	 * facility and basic details of the baby using one collection
	 **/
	...
	/**
	 * Get details of baby using unique_id whether it born facility or home
	 * @param u_id - unique_id of the baby
	 * @param coll - collection name
	 * @return object which contains details of the baby)
	...
	/**
	 * This method is to get details of no. of babies grouped, duplicate, readmit
	 * @param datefrom & dateto = from and todate of from1 period
	 **/
