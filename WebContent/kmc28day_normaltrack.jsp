...
<body onload="backToLogin()">
	...
	<% 
		String facValues = request.getParameter("facility");
		System.out.println("facility in kmc track jsp ="+facValues);
	
		String kmcprd = request.getParameter("kmcPeriod");
		System.out.println("kmcperiod in kmc track jsp ="+kmcprd);
		
		String newdatefrom = request.getParameter("date_from");
		System.out.println("datefrom in kmc track jsp ="+newdatefrom);
		
		String newdateto = request.getParameter("newdateto");
		System.out.println("dateto in kmc track jsp ="+newdateto);
	%>
	<%
		String period_name = null;
		if(kmcprd.equals("4"))
		{
			period_name="28day_normal_Babies";
			%>
			<h3 style="color:brown; text-align:center;"> 28thday Normal Babies </h3>
			<%
		}
		...
		{			
			...
			<div class="container">				
			<div class="row">				
			<div id=<%= period_name%> class="exporttable table-responsive2">				  
